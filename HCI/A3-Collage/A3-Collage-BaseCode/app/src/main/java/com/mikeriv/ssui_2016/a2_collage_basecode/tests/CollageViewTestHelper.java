...
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.*;
...
public abstract class CollageViewTestHelper {
    ...
    private static final String TAG = "SSUI_A2_TESTS";
    ...
    private static final void runAPITest1(CollageView collageView, Context context) {
        ...
        try{
            ...
            numTestsPassed += 1;
        } catch (Exception e){ Log.d(TAG, "Add null Child:FAIL");
            numTestsFailed += 1;
        }
       ...
       try{
           if(rootVisualElement.getChildAt(-1) == null) {
                ...
                Log.d(TAG, "Get bad Child:FAIL");numTestsFailed += 1;
           }
        } catch (Exception e){
