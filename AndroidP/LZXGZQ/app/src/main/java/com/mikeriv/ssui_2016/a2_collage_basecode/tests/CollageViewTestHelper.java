...
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.basic_drawing.IconImage;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.basic_drawing.NinePartImage;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.basic_drawing.SimpleFrame;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.basic_drawing.SolidBackDrop;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.basic_drawing.TextVisualElement;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.clipping.OvalClip;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.layout.CircleLayout;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.layout.ColumnLayout;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.layout.PileLayout;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.layout.RowLayout;
import android.graphics.NinePatch;
...
public abstract class CollageViewTestHelper {
    ...
    private static final void runTest2(CollageView collageView, Context context) {
         ...
         **/
        SolidBackDrop rootVisualElement = new SolidBackDrop(0, 0, 2000, 2000, Color.WHITE);

        putSamplesInElement(rootVisualElement, false, context);

        PileLayout p = new PileLayout(10, 500, 400, 400);
        p.addChild(new SolidBackDrop(0, 0, 1500, 1500, Color.YELLOW));
        p.addChild(new SimpleFrame(0, 0, 400, 400));
        rootVisualElement.addChild(p);
        putSamplesInElement(p, false, context);

        p.addChild(new SolidBackDrop(0, 0, 40, 40, Color.CYAN));
        RowLayout r = new RowLayout(10, 1000, 700, 100);
        rootVisualElement.addChild(r);
        putSamplesInElement(r, false, context);


        ColumnLayout col = new ColumnLayout(10, 1500, 100, 400);
    ...
    private static final void runTest4(CollageView collageView, Context context){
        ...
        SolidBackDrop rootVisualElement = new SolidBackDrop(0, 0, 2000, 2000, Color.CYAN);

        TextVisualElement t=new TextVisualElement(100,500,"Amber and Liu",
                Typeface.DEFAULT_BOLD,100);
        rootVisualElement.addChild(t);
        ...
        IconImage i = new IconImage(
                ...
                BitmapFactory.decodeResource(
                        context.getResources(),
                        R.drawable.ic_noun_cat));
        rootVisualElement.addChild(i);

        //maybe the NinePatch is invalid because of the API level
        Bitmap bmp = BitmapFactory.decodeResource(context.getResources(),R.drawable.ic_noun_cat);
        NinePatch npd = new NinePatch(bmp,bmp.getNinePatchChunk());
        NinePartImage np=new NinePartImage(500,1000,300,300,npd);
