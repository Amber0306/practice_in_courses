...
public class PuzzleGameBoard {
    ...
    /**
     * Checks if two tiles neighbor each other on the gameboard along the vertical and horizontal
     * axes:
    ...
    public boolean areTilesNeighbors(
        ...
        if((firstTileCol == secondTileCol && Math.abs(firstTileRow-secondTileRow) == 1) ||(
                firstTileRow == secondTileRow && Math.abs(firstTileCol-secondTileCol) == 1))
            return true;
        return false;
